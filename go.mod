...
require (
	buf.build/gen/go/envoyproxy/envoy/connectrpc/go v1.15.0-20240312202909-344c0a24b5e3.1
	buf.build/gen/go/envoyproxy/envoy/protocolbuffers/go v1.33.0-20240312202909-344c0a24b5e3.1
...
require (
	buf.build/gen/go/cncf/xds/protocolbuffers/go v1.33.0-20240307201952-62c94a646f3e.1 // indirect

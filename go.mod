...
require (
	buf.build/gen/go/envoyproxy/envoy/connectrpc/go v1.16.2-20240703201249-823ba58cacdf.1
	buf.build/gen/go/envoyproxy/envoy/protocolbuffers/go v1.34.2-20240703201249-823ba58cacdf.2

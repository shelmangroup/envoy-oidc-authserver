...
require (
	buf.build/gen/go/envoyproxy/envoy/connectrpc/go v1.16.2-20240710202423-9664401729da.1
	buf.build/gen/go/envoyproxy/envoy/protocolbuffers/go v1.34.2-20240710202423-9664401729da.2
